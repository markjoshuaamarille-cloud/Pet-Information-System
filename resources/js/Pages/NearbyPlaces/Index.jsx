...
export default function NearbyPlacesIndex() {
    ...
    const searchFromCoordinates = useCallback(
        (lat, lng, sourceLabel = null) => {
        ...
        (showErrors = true) => {
            ...
            navigator.geolocation.getCurrentPosition(
                ...
                () => {
                    ...
                    if (showErrors) {
                        setError(
                            "Location access was denied. Search by place name or use the Manila default.",
                        );
                    }
                    setShowManualEntry(true);
                },
    ...
    const searchByPlaceName = async (e) => {
        ...
        if (query.length < 2) {
            setError(
                "Please enter a place name (e.g. Quezon City, Cebu, Davao).",
            );
            return;
        }
            ...
            <div className="py-8">
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 rounded-lg border border-indigo-100 bg-indigo-50 p-4 text-sm text-indigo-900">
                        <p>
                            Showing nearby veterinary clinics, pet shops, and
                            grooming salons around Manila by default. Use{" "}
                            <strong>Use my location</strong> for GPS, or search
                            another place by name.
                        </p>
                    </div>
                    ...
                    {showManualEntry && (
                        <form
                            onSubmit={searchByPlaceName}
                            className="mb-6 space-y-4 rounded-lg bg-white p-4 shadow"
                        >
                            <div>
                                <InputLabel
                                    htmlFor="place-name"
                                ...
                                <p className="mt-1 text-xs text-gray-500">
                                    Enter a city, barangay, or area name to
                                    search nearby clinics and pet shops there.
                                </p>
                            </div>
                    ...
                    <div className="mb-6 grid gap-6 lg:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-2 text-xs text-gray-500">
                                Blue dot = search center. Red markers = nearby
                                places. Circle shows 5 km search radius.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            {!loading &&
                                ...
                                places.length === 0 && (
                                    <p className="text-sm text-gray-500">
                                        No places found within 5 km. Try a
                                        different filter or location.
                                    </p>
                                )}

                            {!location && !loading && !locating && !error && (
                                <p className="text-sm text-gray-500">
                                    Allow location access or search by place
                                    name.
                                </p>
                            )}
