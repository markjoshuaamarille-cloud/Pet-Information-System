...
const navItems = [
    ...
    { href: 'pets.index', label: 'Pets', roles: ['super_admin', 'veterinarian', 'receptionist', 'customer', 'cashier'] },
    ...
    { href: 'grooming.index', label: 'Grooming', roles: ['super_admin', 'groomer', 'receptionist', 'cashier'] },
