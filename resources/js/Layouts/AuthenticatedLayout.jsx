...
const navItems = [
    ...
    { href: 'pets.index', label: 'Pets', roles: ['super_admin', 'veterinarian', 'receptionist', 'customer'] },
    { href: 'appointments.index', label: 'Scheduling', roles: ['super_admin', 'veterinarian', 'receptionist', 'customer'] },
    { href: 'vaccinations.index', label: 'Vaccinations', roles: ['super_admin', 'veterinarian', 'receptionist'] },
    { href: 'grooming.index', label: 'Grooming', roles: ['super_admin', 'groomer', 'receptionist'] },
    { href: 'billing.index', label: 'Billing', roles: ['super_admin', 'cashier', 'receptionist'] },
...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const allowedNavItems = navItems.filter((item) => item.roles.length === 0 || item.roles.includes(user.role));
